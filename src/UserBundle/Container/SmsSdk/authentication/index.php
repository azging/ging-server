...
<body>
	...
	<form method="post" action="<?php echo $smsAPI ?>">
        <div>
            <fieldset>
                <legend>发送短信模板</legend>
                AppID:<input name="app_id" type="text" value="<?php echo $appid ?>" readonly= "readonly" />
                AccessToken: <input name="access_token" type="text" value="<?php echo $accessToken ?>"/>
                PhoneNo: <input name="acceptor_tel" type="text" value="13810485137" />
				SmsTemplate: <input name="template_id" type="text" value="91002784"/>
				TemplateParam: <input name="template_param" type="text" value=""/>
				Timestamp: <input name="timestamp" type="text" value="<?php echo date('y-M-d H:m:s',time())?>"/>
                <input name="btn_sms" type="submit" value="发送短信" />
            </fieldset>
        </div>
    </form>
</body>
